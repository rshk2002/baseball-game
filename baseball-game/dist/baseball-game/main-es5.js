...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.playGame = function () {
        ...
        // this.showRestartBtn = false;
        this.config.reqCreate().subscribe(function (res) {
            console.log(res);
            if (res['status'] === 'ok') {
                _this.showNum = true;
                _this.userKey = res['key'];
            }
            else {
...
var ConfigService = /** @class */ (function () {
    ...
    ConfigService.prototype.reqCreate = function () {
        return this.http.get(this.BASE_URL + '/create');
    };
    ConfigService.prototype.reqSubmit = function (body) {
...
var SelectNumComponent = /** @class */ (function () {
    function SelectNumComponent(appComponent, config) {
    ...
    SelectNumComponent.prototype.ngOnInit = function () {
    };
    ...
    //   return msg;
    // }
    SelectNumComponent.prototype.checkInput = function (offenseNum) {
        var oNum0 = parseInt(offenseNum.charAt(0));
        var oNum1 = parseInt(offenseNum.charAt(1));
        var oNum2 = parseInt(offenseNum.charAt(2));
    ...
    SelectNumComponent.prototype.submit = function (oNum0, oNum1, oNum2) {
        var _this = this;
        var input = new _model_input__WEBPACK_IMPORTED_MODULE_3__["Input"]();
        ...
        this.config.reqSubmit(body).subscribe(function (res) {
